    ...
    <>
      <div className="container hidden bg-white w-full px-5  h-[78px] sm:flex justify-between items-center border shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] rounded-[30px] border-solid border-[rgba(0,0,0,0.17)] mx-auto">
        ...
        <div className="sm:flex gap-4 items-center">
          <Link
            href="/dashboard"
            className="text-primary py-1.5 px-[22px] text-center text-xl font-normal border rounded-[18px] border-solid border-primary hover:bg-[#0b8d8c] hover:text-white"
          >
            Log in
          </Link>
          <Link
            href="/dashboard"
            className="text-white bg-black py-1.5 px-[22px] text-center text-xl font-normal  border rounded-[18px] border-solid border-primary hover:bg-[#0b8d8c] hover:text-white"
            // className="container hidden bg-[#099f9e] text-white w-full px-5 h-[78px] sm:flex justify-between items-center border shadow-[0px_1px_4px_0px_rgba(0,0,0,0.25)] rounded-[30px] border-solid border-[rgba(0,0,0,0.17)] mx-auto hover:bg-[#B42318]"
          >
            Sign up
          </Link>
        </div>
